        ...
        <div class="row">
            <div class="col-75">
                <div class="left-details">
                    <h1 class="main-heading"><?php echo "Search Results for: " . get_search_query(); ?></h1>
                </div>
            </div>
            <div class="col-25">
        ...
        <div class="blog-tags-search">
            <div class="left-tags">
                <div class="inner-wrapper">
                    <ul class="tags-list">
                        <li class="tag-item"><a href="<?php echo $page_link; ?>" class="tag-link"><?php _e( 'All', 'seg' ); ?></a></li>
                        <?php
                        foreach ( $categories as $key => $category ) {
                            $class = ($cat_id == $category->term_id) ? 'active' : '';
                            ?>
                            <li class="tag-item <?php echo $class; ?>"><a href="<?php echo get_category_link( $category ); ?>" class="tag-link" data-slug="<?php echo $category->slug; ?>"><?php echo $category->name; ?></a></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
            <div class="right-search">
                <div class="inner-wrapper">
                    <form role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                        <input class="search-input" value="<?php echo get_search_query(); ?>" type="search" name="s" placeholder="Search articles" />
                    </form>
                </div>
            </div>
        </div>
