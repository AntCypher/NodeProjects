                                                ...
                                                <div class="transactions-box-col">
                                                    ...
                                                    <div class="transactions-box-contain">
                                                        ...
                                                        <?php if ( ! empty( $trans_highlight ) ) { ?>
                                                            <a href="<?php echo $trans_permalink; ?>" class="btn-arrow" target="_blank"><?php echo $trans_highlight; ?><span><img src="<?php echo get_template_directory_uri() ?>/images/btn-arrow.png" alt=""></span></a>
                                                                <?php } ?>
                                                    </div>
                                                </div>
                                            </div>
