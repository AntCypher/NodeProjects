...
add_action( 'widgets_init', 'seg_followus_widget' );

/**
 * Register the Follow Us Widget
 */
function seg_followus_widget() {
...
class Followus extends WP_Widget {
    ...
    function __construct(){
        parent::__construct(
                'followus', // Base ID
                __( 'Seg - Follow Us', 'seg' ), // Name
                array('description' => __( 'Custom follow us widget', 'seg' )) // Args
        );
    }
...
<?php
    ...
    ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'seg' ); ?></label> 
