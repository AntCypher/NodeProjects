            ...
            <div class="resources_banner-row">
                <div class="resources_banner-left">
                    <div class="resources_banner-heading">
                        ...
                        <h1 class="resources_banner-title"><?php printf( __( 'Search Results for: %s', 'helthcare' ), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
            ...
            <div class="resources_listing-right pagination_links">
                <div class="resources_box-row">
                    ...
                    if ( have_posts() ) {
                        ...
                        echo '<div class="resources_box-col"><h2>No Search Result Found</h2></div>';
                    }
                    ?>
                </div>
