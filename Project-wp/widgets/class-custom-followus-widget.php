...
add_action( 'widgets_init', 'helthcare_followus_widget' );

/**
 * Register the Follow Us Widget
 */
function helthcare_followus_widget() {
...
class Followus extends WP_Widget {
    ...
    function __construct(){
        parent::__construct(
                'followus', // Base ID
                __( 'Helthcare - Follow Us', 'helthcare' ), // Name
                array('description' => __( 'Custom follow us widget', 'helthcare' )) // Args
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        if( helthcare_check_acf_activation() ) {
...
<?php
    ...
    ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'helthcare' ); ?></label> 
